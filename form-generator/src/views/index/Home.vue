...
export default {
  ...
  data() {
    return {
      ...
      selectComponents: Object.values(selectComponents),
      layoutComponents: Object.values(layoutComponents),
      labelWidth: 100,
      drawingList: drawingDefalut,
      drawingData: {},
      activeId:
        Array.isArray(drawingDefalut) && drawingDefalut.length
          ? drawingDefalut[0].formId
          : "",
      drawerVisible: false,
      formData: {},
      dialogVisible: false,
      ...
      leftComponents: [
        ...
        {
          title: "选择型组件",
          list: Object.values(selectComponents)
        },
        {
          title: "布局型组件",
